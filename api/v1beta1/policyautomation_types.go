...
// PolicyAutomationMode Mode specifies how often automation is initiated. The supported values are "once", "everyEvent",
// and "disabled".
//
...
type AutomationDef struct {
	...
	ExtraVars *runtime.RawExtension `json:"extraVars,omitempty"`
