...
const (
	...
	// PolicyAutomationResouceV policyautomation-ResouceVersion
...
// MatchPAGeneration Check any ansiblejob is made by input genteration number
...
// MatchPAResourceV Check any ansiblejob is made by current resourceVersion number
...
func CreateAnsibleJob(ctx context.Context, policyAutomation *policyv1beta1.PolicyAutomation,
	...
	if policyAutomation.Spec.Automation.ExtraVars != nil {
		// This is to translate the runtime.RawExtension to a map[string]any
