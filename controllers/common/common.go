...
// Package common provides shared utilities for all controllers.
// +kubebuilder:skip
package common
...
// FullNameForPolicy fullNameForPolicy returns the fully qualified name for given policy
...
// GetAffectedObjs Select objects that are deleted or created
