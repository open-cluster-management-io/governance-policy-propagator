...
func (r *RootPolicyReconciler) handleRootPolicy(instance *policiesv1.Policy) error {
	...
	placements, decisions, err := common.GetClusterDecisions(r.Client, instance)
	if err != nil {
	...
	cpcs, cpcsErr := common.CalculatePerClusterStatus(r.Client, instance, decisions)
	if cpcsErr != nil {
	...
	instance.Status.ComplianceState = common.CalculateRootCompliance(cpcs)
